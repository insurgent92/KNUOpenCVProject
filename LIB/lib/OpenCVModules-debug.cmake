...
set_target_properties(opencv_cudev PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudev300d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG ""
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudev300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudev )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudev "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudev300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudev300d.dll" )
...
set_target_properties(opencv_cudaarithm PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudaarithm300d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_cudev;opencv_core"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudaarithm300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudaarithm )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudaarithm "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudaarithm300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudaarithm300d.dll" )
...
set_target_properties(opencv_cudalegacy PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudalegacy300d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudalegacy300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudalegacy )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudalegacy "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudalegacy300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudalegacy300d.dll" )
...
set_target_properties(opencv_cudawarping PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudawarping300d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudawarping300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudawarping )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudawarping "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudawarping300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudawarping300d.dll" )
...
set_target_properties(opencv_cuda PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cuda300d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cuda300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cuda )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cuda "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cuda300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cuda300d.dll" )
...
set_target_properties(opencv_cudafilters PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudafilters300d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_cudev;opencv_core;opencv_cudaarithm;opencv_imgproc"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudafilters300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudafilters )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudafilters "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudafilters300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudafilters300d.dll" )
...
set_target_properties(opencv_cudaimgproc PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudaimgproc300d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_cudev;opencv_core;opencv_cudaarithm;opencv_imgproc;opencv_cudafilters"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudaimgproc300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudaimgproc )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudaimgproc "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudaimgproc300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudaimgproc300d.dll" )
...
set_target_properties(opencv_cudabgsegm PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudabgsegm300d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudabgsegm300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudabgsegm )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudabgsegm "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudabgsegm300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudabgsegm300d.dll" )
...
set_target_properties(opencv_cudacodec PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudacodec300d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_cudev;opencv_core;opencv_imgproc;opencv_imgcodecs;opencv_videoio"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudacodec300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudacodec )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudacodec "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudacodec300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudacodec300d.dll" )
...
set_target_properties(opencv_cudafeatures2d PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudafeatures2d300d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudafeatures2d300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudafeatures2d )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudafeatures2d "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudafeatures2d300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudafeatures2d300d.dll" )
...
set_target_properties(opencv_cudaoptflow PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudaoptflow300d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudaoptflow300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudaoptflow )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudaoptflow "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudaoptflow300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudaoptflow300d.dll" )
...
set_target_properties(opencv_cudastereo PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudastereo300d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudastereo300d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_cudastereo )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_cudastereo "${_IMPORT_PREFIX}/x64/vc12/lib/opencv_cudastereo300d.lib" "${_IMPORT_PREFIX}/x64/vc12/bin/opencv_cudastereo300d.dll" )
...
set_target_properties(opencv_ts PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_cudev;opencv_core;opencv_imgproc;opencv_imgcodecs;opencv_videoio;opencv_highgui;glu32;opengl32;ippicv;cudart;nppc;nppi;npps;cublas;cufft;cudart;nppc;nppi;npps"
